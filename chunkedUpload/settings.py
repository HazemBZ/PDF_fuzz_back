...
DEFAULT_UPLOAD_PATH = 'uploads/chunked_uploads/%Y/%m/%d'
...
def default_upload_to(instance, filename):
    filename = os.path.join(UPLOAD_PATH, instance.upload_id, instance.upload_id + '.part')
...
# determine the "null" and "blank" properties of "user" field 
# in the "ChunkedUpload" model
